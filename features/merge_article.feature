Feature: Merge Blog
  ...
  Scenario: When articles are merged, the merged article should contain the text of both previous articles
	...
	And I merge with "Article B"
    Then I should see the text of "Article A"
    And I should see the text of "Article B"
    #And show me the page
    # And I should see the author of "Article A" or "Article B"
    # And I should see comments from "Article A"
    # And I should see comments from "Article B"
    And I should see the title from "Article A" or "Article B"
